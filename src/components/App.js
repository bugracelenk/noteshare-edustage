              ...
              <div class="owl-carousel active_course">
                    ...
                    <div class="course_meta d-flex justify-content-lg-between align-items-lg-center flex-lg-row flex-column mt-4">
                      ...
                      <div class="mt-lg-0 mt-3">
                        <span class="meta_info mr-4">
                          <a href="#">
                            {" "}
                            <i class="ti-user mr-2" />25{" "}
                          </a>
                        </span>
                        <span class="meta_info">
                          <a href="#">
                            {" "}
                            <i class="ti-heart mr-2" />35{" "}
                          </a>
                        </span>
                      </div>
                    </div>
                ...
                <div class="single_course">
                  ...
                  <div class="course_content">
                    ...
                    <div class="course_meta d-flex justify-content-lg-between align-items-lg-center flex-lg-row flex-column mt-4">
                      <div class="authr_meta">
                        <img src={require('../img/courses/author3.png')} alt="" />
                        <span class="d-inline-block ml-2">Cameron</span>
                      </div>
                      <div class="mt-lg-0 mt-3">
                        <span class="meta_info mr-4">
        ...
        <div class="row justify-content-center d-flex align-items-center">
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            <div class="thumb d-flex justify-content-sm-center">
              <img class="img-fluid" src={require('../img/trainer/t1.jpg')} alt="" />
            </div>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            <div class="thumb d-flex justify-content-sm-center">
              <img class="img-fluid" src={require('../img/trainer/t2.jpg')} alt="" />
            </div>
            <div class="meta-text text-sm-center">
              <h4>David Cameron</h4>
              <p class="designation">Sr. web designer</p>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            <div class="thumb d-flex justify-content-sm-center">
              <img class="img-fluid" src={require('../img/trainer/t3.jpg')} alt="" />
            </div>
            <div class="meta-text text-sm-center">
              <h4>Jain Redmel</h4>
          ...
          <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
            <div class="thumb d-flex justify-content-sm-center">
              <img class="img-fluid" src={require('../img/trainer/t4.jpg')} alt="" />
            </div>
            <div class="meta-text text-sm-center">
              <h4>Nathan Macken</h4>
              <p class="designation">Sr. web designer</p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="single_event position-relative">
              <div class="event_thumb">
                <img src={require('../img/event/e1.jpg')} alt="" />
              </div>
          ...
          <div class="col-lg-6 col-md-6">
            <div class="single_event position-relative">
              <div class="event_thumb">
                <img src={require('../img/event/e2.jpg')} alt="" />
              </div>
              <div class="event_details">
                <div class="d-flex mb-4">
                  <div class="date"><span>15</span> Jun</div>
